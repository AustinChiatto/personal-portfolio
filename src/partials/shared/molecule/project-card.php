<article class="m-project-card js-project-card">
    ...
    <a class="m-project-card__link" href="<?php echo h($project->link) ?>">
        <img src="../src/assets/images/<?php echo h($project->image_url) ?>" alt="<?php echo h($project->name) . " " . h($project->type)?>" data-tilt data-tilt-max="15" data-tilt-perspective="2000">
    </a>
