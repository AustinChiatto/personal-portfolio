...
$technology_panel_content = '
    ...
    <article class="m-content-panel__section">
        <h4 class="m-content-panel__copy-heading">Figma</h4>
        <p class="a-text--copy">For the design of the project I used Figma, I think it pairs really well with a framework like React as building out the components while designing sets the stage for how the structure of the code will be handled</p>
        <p class="a-text--copy">With the inclusion of the new "dev" mode inside Figma, this process is even easier as it now provides a lot of the information needed for each component write in VS Code with the added extension.</p>
    </article>
';
?>
