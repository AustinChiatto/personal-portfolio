    ...
    <main>
        ...
        <section class="s-section">
            <div class="s-section__content m-intro-container--md">
                <h1 class="a-text--lg a-text--center"><span class="a-text--highlight">My friends call me bald <br> but most</span> call me Austin</h1>
            </div>
        </section>
        <section class="s-section">
            <div class="s-section__content--wide">
                <ul class="m-link-list">
                    ...
                    <li><a class="a-button--new" href="https://github.com/AustinChiatto" target="_blank" title="View my GitHub profile">GitHub</a></li>
                </ul>
                <!-- Personal Images -->
        ...
        <section class="s-section">
            <div class="s-section__content m-intro-container--block">
